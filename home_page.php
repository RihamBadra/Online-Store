...
<div  class="navbar">
<div class="dropdown"> 
<button href="victoria_page.php"   class="dropbtn"> VICTORIA SECRET &nbsp;&nbsp; ➤</button>
 <div class="dropdown-content">
 <a href="victoria_page.php" style="color:black;"> PERFUMES </a>
 <a href="victoria_page.php" style="color:black;"> BODYLOTION   </a>
<a href="victoria_page.php" style="color:black;"> SPRAY  </a>
<a href="victoria_page.php" style="color:black;" > SETS</a>  
</div> </div> 
<div class="dropdown"> 
